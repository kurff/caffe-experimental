...
class DetectionEvaluateCascadeLayer : public Layer<Dtype> {
 public:
  explicit DetectionEvaluateCascadeLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionEvaluateCascade"; }
