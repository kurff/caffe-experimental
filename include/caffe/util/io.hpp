...
// added by kurffzhou
///////////////////////////////////////////////////////////////////////////////////////////////
bool ReadProtoFromTextFileEncrypt(Security* security, const char* filename, Message* proto);
bool ReadProtoFromBinaryFileEncrypt(Security* security, const char* filename, Message* proto);

//void ReadProtoFromTextFileEncryptOrDie(Security* security, const char* filename, Message* proto){
//  CHECK(ReadProtoFromTextFileEncrypt(security,filename,proto));
//}

//void ReadProtoFromBinaryFileEncryptOrDie(Security* security, const char* filename, Message* proto){
//  CHECK(ReadProtoFromBinaryFileEncrypt(security, filename, proto));
//}


//void WriteProtoToTextFileEncrypt(const Message& proto, const char* filename);
//void WriteProtoToBinaryFileEncrypt();
...
bool ReadImageAttributeToDatum(const string& filename, const vector<int>& label,
    const int height, const int width, const int min_dim, const int max_dim,
    const bool is_color, const std::string & encoding, Datum* datum);

inline bool ReadImageAttributeToDatum(const string& filename, const vector<int>& label,
        const int height, const int width, const bool is_color,
    const std::string & encoding, Datum* datum){

      return ReadImageAttributeToDatum(filename, label, height, width, 0, 0, is_color,
                          encoding, datum);
    }
