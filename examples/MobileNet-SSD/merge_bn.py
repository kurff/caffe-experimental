...
train_proto = 'example/MobileNetSSD_train_dw_fromcoco.prototxt'  
train_model = 'snapshot/mobilenet_fromcoco_iter_120000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'example/MobileNetSSD_deploy_dw_fromcoco.prototxt'  
save_model = 'snapshot/MobileNetSSD_deploy_fromcoco.caffemodel'
