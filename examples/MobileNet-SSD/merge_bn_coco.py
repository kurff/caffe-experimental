...
train_proto = 'example/MobileNetSSD_train_coco_dw.prototxt'  
train_model = 'snapshot/mobilenet_coco_iter_120000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'example/MobileNetSSD_deploy_coco_dw.prototxt'  
save_model = 'snapshot/MobileNetSSD_deploy_coco.caffemodel'
